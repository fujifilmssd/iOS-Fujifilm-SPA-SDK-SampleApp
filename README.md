...
In your Podfile, include the SPA SDK pod:
```ruby 
pod "Fujifilm-SPA-SDK"
```
If it is not already added, make sure your Podfile contains the use_frameworks! instruction. Install the pod by running $ pod install inside your project directory. Upon successful installation, close your Xcode project if it is open, and open the workspace that was generated by Cocoapods.
