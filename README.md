...
```
Install the pod by running $ pod install inside your project directory. If you have already installed the SDK and would like to update to the latest version, run $ pod update instead. 
