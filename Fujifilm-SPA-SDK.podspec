Pod::Spec.new do |spec|
  ...
  spec.version              = '1.7.28'
  spec.summary              = "Enable photo product output through Fujifilm! Access over 100 photo products and control the availability and pricing through fujifilmapi.com"
